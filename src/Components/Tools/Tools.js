      ...
      <div className="cards">
          {
              tools.slice(0, 3).map((tool) =>(
                  <div key={tool._id} className="single-card">
                      ...
                      <button onClick={()=>handleEachTool(tool._id)} className="btn-tool"><i className="fa-solid fa-plus"></i></button>
                      </div>
                      ...
                      <div className="quantities">
                          ...
                          <div className='quantities-tool-wrapper'>
                              ...
                              <p className="quantities-tool-value">{tool.avlQuantity} <sub>unit</sub> </p>
                          </div>
                          <div className="quantities-tool-wrapper">
                              <p className="quantities-tool-item">Minimum Order Quantity</p>
                              <p className="quantities-tool-value">{tool.minQuantity} <sub>unit</sub></p>
                          </div>
                      </div>
